...
file=r"C:\Users\artem\Desktop\project\trial\experiment\Face-Mask-Detection-master\GUI\narration.mpeg"
pygame.init()
pygame.mixer.init()
...
def Play_music():
    pygame.mixer.music.load(r"C:\Users\artem\Desktop\project\trial\experiment\Face-Mask-Detection-master\GUI\narration.mpeg")
...
def Ok():
    ...
    if (uname == "" or password == ""):
        ...
        def live_cam():
            capture = cv2.VideoCapture("rtsp://admin:frass@123@192.168.1.64/1")
...
#             announce= mixer.Sound('announce.mp3')
            ...
            vs = VideoStream(src='rtsp://admin:frass@123@192.168.1.64/1').start()
...
load5=Image.open(r"C:\Users\artem\Desktop\project\trial\experiment\Face-Mask-Detection-master\GUI\play.png")
play=ImageTk.PhotoImage(load5)
load6=Image.open(r"C:\Users\artem\Desktop\project\trial\experiment\Face-Mask-Detection-master\GUI\pause.png")
