...
def Ok():
    ...
    if (uname == "" or password == ""):
        ...
        def Cmds():
            ...
            canvas.pack()
            my_image = PhotoImage(file=r"D:\Mask Detection-Final\Mask Detection\GUI\manual.png", master=admin)
            canvas.create_image(0, 0, anchor=NW, image=my_image)
            r.mainloop()
        ...
        def open_folder():
            os.startfile(r"D:\projects\mask detection\database")
            pass
        ...
        def auto():
            ...
            b5 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="green" , command = auto)
            b5.place(x=230, y=175)
            b6 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"),fg='white', bg="red", command = no_auto)
        ...
        def no_auto():
            ...
            b5 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="red" ,  command = auto)
            b5.place(x=230, y=175)
            b6 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"),fg='white', bg="green" , command = no_auto)
            b6.place(x=294, y=175)
            pass
        def no_buzzer():
            global d
            ...
            b7 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="red", command=buzzer)
            b7.place(x=230, y=235)
            b8 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"),fg='white', bg="green", command=no_buzzer)
        ...
        def buzzer():
            ...
            b7 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="green", command=buzzer)
            b7.place(x=230, y=235)
            b8 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"),fg='white', bg="red", command=no_buzzer)
            b8.place(x=294, y=235)
            pass   
        def no_ann():
            global e
            ...
            b9 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="red", command=ann)
            b9.place(x=250, y=295)
            b10 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"), bg="green",fg='white', command=no_ann)
            b10.place(x=314, y=295)
            pass
        def ann():
            global e
            e=1
            print("announcement enabled")
            b9 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="green", command=ann)
            b9.place(x=250, y=295)
            b10 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"), bg="red",fg='white', command=no_ann)
            b10.place(x=314, y=295)
            pass   
...
#             announce= mixer.Sound('announce.mp3')
            ...
            def screenshot(vs):
                ...
                outfile = r"D:\projects\mask detection\database\%i.jpg" % (z)
            ...
            while True:
                ...
                if key == 27:
                    break
                if key == ord('s'):  # calls screenshot function when 'c' is pressed
                    screenshot(vs)
            # do a bit of cleanup
            cv2.destroyAllWindows()
            vs.stop()
        ...
        filename = PhotoImage(file=r"D:\Mask Detection-Final\Mask Detection\GUI\bg.png")
        background_label = Label(image=filename)
        background_label.place(x=0, y=0, relwidth=1, relheight=1.15)

        load2 = Image.open(r"D:\Mask Detection-Final\Mask Detection\GUI\gt1.png")
        ...
        l3 = tk.Label(canvas2, text="Camera Feed", font=("Calibiri", 12,"bold"), bg='teal',fg='white',bd='5')
        l3.place(x=30, y=15)
        #Label(admin, text="camera feed").place(x=10, y=10)
        #Button(admin, text="start", command=live_cam, height=1, width=13).place(x=180, y=10)
        b2 = tk.Button(canvas2, text="      Start      ", font=("Calibiri", 10,"bold"), bg="red",fg='white', command=live_cam)
        b2.place(x=240, y=15)


        #Label(admin, text="mask detection").place(x=10, y=40)
        #button(admin, text="start", command=detect, height=1, width=13).place(x=180, y=40)
        l4 = tk.Label(canvas2, text=" Mask Detect ", font=("Calibiri", 12,"bold"),fg='white', bg='teal',bd='5')
        l4.place(x=30, y=65)
        # Label(admin, text="camera feed").place(x=10, y=10)
        # Button(admin, text="start", command=live_cam, height=1, width=13).place(x=180, y=10)
        b3 = tk.Button(canvas2, text="      Start      ", font=("Calibiri", 10,"bold"), bg="red",fg='white', command=detect)
        b3.place(x=240, y=65)

        l5 = tk.Label(canvas2, text=" Database Folder ", font=("Calibiri", 12,"bold"),fg='white', bg='teal',bd='5')
        l5.place(x=30, y=115)
        b4 = tk.Button(canvas2, text="      Open      ", font=("Calibiri", 10,"bold"),fg='white', bg="red", command=open_folder)
        b4.place(x=240, y=115)

        l6 = tk.Label(canvas2, text="Automatic Screenshot", font=("Calibiri", 12,"bold"),fg='white', bg='teal',bd='5')
        l6.place(x=30, y=175)
        b5 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="red", command=auto)
        b5.place(x=230, y=175)
        b6 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"),fg='white', bg="green", command=no_auto)
        ...
        l7 = tk.Label(canvas2, text="Buzzer Alarm", font=("Calibiri", 12,"bold"),fg='white', bg='teal',bd='5')
        l7.place(x=30, y=235)
        b7 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="red", command=buzzer)
        b7.place(x=230, y=235)
        b8 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"),fg='white', bg="green", command=no_buzzer)
        ...
        l8 = tk.Label(canvas2, text="Automatic Announcement", font=("Calibiri", 12,"bold"), fg='white',bg='teal',bd='5')
        l8.place(x=30, y=295)
        b9 = tk.Button(canvas2, text="Enable", font=("Calibiri", 10,"bold"),fg='white', bg="red", command=ann)
        b9.place(x=250, y=295)
        b10 = tk.Button(canvas2, text="Disable", font=("Calibiri", 10,"bold"), bg="green",fg='white', command=no_ann)
        ...
        b11 = tk.Button(admin, text="User Manual", font=("Calibiri", 12,"bold"), bg="green",fg='white',command=Cmds)
...
load5=Image.open(r"D:\Mask Detection-Final\Mask Detection\GUI\play.png")
play=ImageTk.PhotoImage(load5)
load6=Image.open(r"D:\Mask Detection-Final\Mask Detection\GUI\pause.png")
pause=ImageTk.PhotoImage(load6)

C = Canvas(bg="blue", height=850, width=300)
filename = PhotoImage(file=r"D:\Mask Detection-Final\Mask Detection\GUI\bg2.png ")
background_label = Label(image=filename)
background_label.place(x=0, y=0, relwidth=1, relheight=1.3)

load1=Image.open(r"D:\Mask Detection-Final\Mask Detection\GUI\gt1.png")
